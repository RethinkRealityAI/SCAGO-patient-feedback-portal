    ...
    <div className="py-4 sm:py-6">
      <header className="mb-6 sm:mb-8">
        <div className="text-center space-y-4">
          <div className="inline-flex items-center justify-center p-3 rounded-2xl bg-primary/10 border border-primary/20 mb-6 shadow-sm">
          ...
          {/* Language Toggle */}
          <div className="flex items-center justify-center gap-3 mt-6 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-200/60 dark:border-gray-700/50 max-w-xs mx-auto shadow-sm">
      ...
      <div className="space-y-3 sm:space-y-4">
        {surveys.length > 0 ? (
            ...
            >
              ...
              >
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="p-2 sm:p-3 rounded-xl bg-primary/10 border border-primary/20 group-hover:bg-primary/20 group-hover:scale-110 transition-all duration-300 shrink-0 shadow-sm">
          ...
          <div className="flex flex-col items-center justify-center p-6 sm:p-8 lg:p-12 text-center rounded-lg border bg-card text-card-foreground shadow-sm">
            <div className="p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200/60 dark:border-gray-700/50 mb-6 shadow-sm">
