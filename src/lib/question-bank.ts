  ...
  advanced: [
    ...
    },
    {
      ...
      fieldConfig: {
        ...
        rows: [
          { id: nanoid(), label: 'Wait time', value: 'wait-time' },
          { id: nanoid(), label: 'Staff friendliness', value: 'staff-friendliness' },
          { id: nanoid(), label: 'Cleanliness', value: 'cleanliness' },
          { id: nanoid(), label: 'Communication', value: 'communication' },
        ],
        columns: [
          { id: nanoid(), label: 'Very Poor', value: '1' },
          { id: nanoid(), label: 'Poor', value: '2' },
          { id: nanoid(), label: 'Fair', value: '3' },
